...
import { handleReadFile, handleWriteFile, handleListDirectory, handleSearchFiles, handleFetchFile, handlePushFile, handleListProjects, handleDelete, handleMoveFile, handleFetchArchive, handleWriteArchive, handleBrowse } from './file-tools.js'
...
import { handleBrowserOpen, handleBrowserSnapshot, handleBrowserClick, handleBrowserFill, handleBrowserPress, handleBrowserScreenshot, handleBrowserBack, handleBrowserGetUrl, handleBrowserConnect, handleSpawnDetached, handleBrowserEval, handleBrowserSniff, handleUserscriptRun } from './browser-tools.js'
  ...
  return {
    async dispatch(tool: string, args: Record<string, unknown>): Promise<string> {
      switch (tool) {
        ...
        case 'remote_browse': return handleBrowse(args, validatePath, baseDir)
        ...
        case 'remote_browser_sniff': return handleBrowserSniff(args)
        case 'remote_userscript_run': return handleUserscriptRun(args)
        case 'remote_ig_post': return handleIgPost(args, validatePath)
