...
const guideTranslations = {
  zh: {
    ...
    ch12_deploy: '部署專案 (commit + merge + push)',
    ch12_sync: '同步所有 worktree',
    ch12_claudemd: '自動生成/更新 CLAUDE.md',
    ch12_model: '切換 AI 模型（Claude / Gemini / Auto）',
    ch12_new: '開啟新對話（清除 session）',
    ch12_cancel: '取消目前正在執行的 AI 任務',
    ch12_chat: '輕量聊天模式（不載入專案上下文）',
    ch12_asr: '開關語音辨識',
    ch12_bv: '網頁視覺分析 (Playwright + Gemini)',
    ch12_chain: '指令鏈自動化工作流',
    ch12_last: '重送最近訊息 (/last2=上上條)',
    ch12_ctx: '查看/管理上下文摘要',
    ch12_deep: '深度分析 (Opus + subagent)',
    ch12_parallel: '平行執行多個任務',
    ch12_pair: '配對遠端電腦',
    ch12_unpair: '斷開遠端配對',
    ch12_rpair: '重啟遠端 agent',
    ch12_grab: '從遠端下載檔案',
    ch12_rstatus: '查看遠端系統狀態',
    ch12_rlog: '查看遠端 log',
    ch12_rexec: '在遠端執行指令',
    ch12_desktop: '列出遠端桌面檔案',
    ch12_downloads: '列出遠端下載資料夾',
    ch12_ls: '列出遠端目錄',
    ch12_rcat: '讀取遠端檔案內容',
    ch12_rwrite: '寫入遠端檔案',
    ch12_rinfo: '遠端系統資訊',
    ...
    ch12_idea: '記錄靈感',
    ch12_ideas: '查看靈感列表',
    ch12_save: '儲存訊息 (書籤/釘選/AI記憶)',
    ch12_recall: '叫回書籤',
    ch12_unsave: '刪除書籤',
    ch12_vault: '訊息索引/搜尋/注入/摘要',
    ch12_help: '查看所有可用指令',
    ch12_newbot: '產生新 Bot 的 .env 設定模板',
    ch12_reload: '熱重載插件（不重啟 Bot）',
    ch12_restart: '重啟 Bot',
    ch12_stats: '生產力統計',
    ch12_cost: '查看 AI 花費面板',
    ch12_sysinfo: '查看系統資訊',
    ch12_mdfix: 'Markdown 修正設定',
  ...
  en: {
    ...
    ch12_cat_remote: 'Remote Control',
    ...
    ch12_deploy: 'Deploy project (commit + merge + push)',
    ch12_sync: 'Sync all worktrees',
    ch12_claudemd: 'Auto-generate/update CLAUDE.md',
    ...
    ch12_bv: 'Web vision analysis (Playwright + Gemini)',
    ch12_chain: 'Command chaining workflow automation',
    ch12_last: 'Resend last message (/last2 = 2nd last)',
    ch12_ctx: 'View/manage context digest',
    ch12_deep: 'Deep analysis (Opus + subagent)',
    ch12_parallel: 'Execute multiple tasks in parallel',
    ch12_pair: 'Pair a remote machine',
    ch12_unpair: 'Disconnect remote pairing',
    ch12_rpair: 'Restart remote agent',
    ch12_grab: 'Download file from remote',
    ch12_rstatus: 'View remote system status',
    ch12_rlog: 'View remote logs',
    ch12_rexec: 'Execute command on remote',
    ch12_desktop: 'List remote desktop files',
    ch12_downloads: 'List remote downloads folder',
    ch12_ls: 'List remote directory',
    ch12_rcat: 'Read remote file content',
    ch12_rwrite: 'Write to remote file',
    ch12_rinfo: 'Remote system info',
    ch12_find: 'Search remote files',
    ch12_todo: 'Add todo item',
    ch12_todos: 'View todo list',
    ch12_idea: 'Record an idea',
    ch12_ideas: 'View ideas list',
    ch12_save: 'Save message (bookmark/pin/AI memory)',
    ch12_recall: 'Recall bookmark',
    ch12_unsave: 'Delete bookmark',
    ch12_vault: 'Message index/search/inject/summary',
    ...
    ch12_restart: 'Restart Bot',
    ch12_stats: 'Productivity statistics',
    ch12_cost: 'View AI cost dashboard',
    ch12_sysinfo: 'View system info',
    ch12_mdfix: 'Markdown formatting settings',
