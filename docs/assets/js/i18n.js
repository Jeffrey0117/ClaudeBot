...
const translations = {
  zh: {
    ...
    cmd_cost: '查看 AI 花費面板',
    cmd_sysinfo: '查看系統資訊',
    cmd_bv: '網頁視覺分析 (Playwright + Gemini)',
    cmd_chain: '指令鏈自動化 (串聯 bv/pipe/cmd/notify)',
    cmd_last: '重送最近訊息 (/last2=上上條)',
    cmd_rpair: '重啟遠端 agent',
    cmd_rlog: '查看遠端 log',
    cmd_downloads: '列出遠端下載資料夾',
    cmd_rcat: '讀取遠端檔案內容',
    cmd_rwrite: '寫入遠端檔案',
    cmd_rinfo: '遠端系統資訊',
    cmd_find: '搜尋遠端檔案',
  ...
  en: {
    ...
    cmd_bv: 'Web vision analysis (Playwright + Gemini)',
    cmd_chain: 'Command chaining (bv/pipe/cmd/notify workflows)',
    cmd_last: 'Resend last message (/last2 = 2nd last)',
    cmd_rpair: 'Restart remote agent',
    cmd_rlog: 'View remote logs',
    cmd_downloads: 'List remote downloads folder',
    cmd_rcat: 'Read remote file content',
    cmd_rwrite: 'Write to remote file',
    cmd_rinfo: 'Remote system info',
    cmd_find: 'Search remote files',
    cmd_recall: 'Recall bookmark (by name)',
    cmd_unsave: 'Delete bookmark',
    cmd_mdfix: 'Markdown formatting settings',
